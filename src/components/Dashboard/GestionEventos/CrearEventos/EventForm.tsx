...
import MultiImageUpload from "@/components/Dashboard/GestionEventos/CrearEventos/UI/MultiImageUpload";
        ...
        <>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <FloatingField label="Link a Red Social 2 (opcional)" htmlFor="social2">
                        <input
                            id="social2"
                            name="social2"
                            type="url"

...
const SidebarUsuario = () => {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside
                className={`fixed inset-y-0 left-0 z-[9999999999999999] flex min-h-screen w-64 flex-col bg-primary   p-6 text-white shadow-lg transition-transform duration-200 ease-in-out ${isOpen ? "translate-x-0" : "-translate-x-full"
